				...
				<li class="panel ">
    <a href="#" data-parent="#menu" data-toggle="collapse" class="accordion-toggle" data-target="#ketua-nav">
        <i class="icon-user"> </i> Data Ketua    
    ...
    <ul class="collapse" id="ketua-nav">  
        <li class=""><a href="index.php?m=contents&p=inputdataketua"><i class="icon-angle-right"></i> Input Data Baru </a></li>
        <li class=""><a href="index.php?m=contents&p=listdataketua"><i class="icon-angle-right"></i> Lihat Data Ketua </a></li>
    </ul>
</li>
