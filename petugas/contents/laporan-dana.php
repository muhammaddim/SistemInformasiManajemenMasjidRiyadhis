...
require __DIR__ . "/../../library/fpdf17/fpdf.php";
...
$pdf = new FPDF('L','mm','A4'); // Gunakan dulu ukuran standar (supaya tidak error)
$pdf->AddPage();

// Lalu override ukuran secara manual
$pdf->w = 360;
$pdf->h = 210;
$pdf->wPt = $pdf->w * $pdf->k;
$pdf->hPt = $pdf->h * $pdf->k;
$pdf->CurPageSize = array($pdf->w, $pdf->h);
...
$pdf->Ln();
$pdf->Cell(140);
$pdf->Cell(50,10,'Masjid Jami Riyadhis | SIMAS',0,0,'C');
$pdf->Ln();
