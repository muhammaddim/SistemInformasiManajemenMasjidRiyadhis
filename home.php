...
<html>
    <head>
        ...
        <title>Selamat Datang - Masjid Jami'Riyadhis</title>
        ...
        <div class="page-content">
            <section id="featured" class="content-section">
                <div class="section-heading">
                    <h1><!--<php echo $_SESSION['username'];?>,--> Agenda Kegiatan<br><em>Masjid Jami'Riyadhis</em></h1>
			...
			<section id="datakeuangan" class="content-section">
                <div class="section-heading">
                    <h1>Data Keuangan<br><em>Masjid Jami'Riyadhis</em></h1>
                    <p>Alhamdulillah, kami ucapkan terimakasih atas
                    <br>Nikmat Allah yang Maha Kuasa.</p>
				<div>
				<br>
